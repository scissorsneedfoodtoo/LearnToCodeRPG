...
label v2_start:
    ...
    show maria
    maria "... And this is your cubicle! We even prepared your name plate!"
    ...
    menu first_day_story_choices:
        ...
        "Ask about Ruby on Rails":
            ...
            player "I've never even worked with it before! Sometimes I wonder if I should have even been hired, because I don't know anything about it."
            ...
            player "Yeah... I made that very clear during my interviews."
