...
label v2_demo:
    ...
    player "Demo websites? Are these real, functioning applications?"
    mala "Yep! We have one for eCommerce apps, landing pages, blogs - you name it!"
    player "That's pretty smart… are they interactive?"
    mala "They are! Basically, customers can go in and play with the apps during a call with a representative, and see how they'd work if they were live."
    ...
    mala "That's what I love about you fishie - you've got so much energy!"
    mala "Just remember -"
    ...
    player "… (SOUND EFFECT: Keyboard press)"
    "You wait."
    "And wait."
    "And wait some more."
    "It's beginning to get quite boring. "
    player "Jeez… this is taking FOREVER."
    player "Did I do something wrong? I remember Goro saying larger queries can take a while to run, but this is ridiculous…"
    player "Maybe I should just abort the script and see if my command is even working? (SOUND: SIGH)"
    "You end the script and check a few of the databases that you included in your query."
    player "Hm… I must have done something wrong with my query somehow?"
    player "It looks like I just dropped the entirety of each of these tables that the script has touched so far. (SWEAT)."
    ...
    player "Yes…"
    mala "O-okay… And you've been deleting from STAGING, right? (SWEAT NEUTRAL) "
    mala "NOT from Production? (SWEAT NEUTRAL)"
    player "… (SWEAT NEUTRAL)"
    iris "[player_name]."
    player "I-Iris!"
    iris "…"
    iris "Come to my office."
    iris "Now, please."
    # * TRANSITION: OFFICE"
    ...
    player "I'm really, really sorry. (SAD)"
    ...
    iris "I expected better. Perhaps we should be more… stringent with our hiring practices. (EYEBROW)"
    ...
    iris "This isn't up for debate, Goro. (EXIT: LEFT)"
    player "But what does a PIP mean? (FEARFUL)"
    goro "A PIP stands for Performance Improvement Plan. (SOUND: SIGH)"
    ...
    player "I can lose my job?! (FEARFUL)"
    player "What do I do?"
    ...
    player "I'll do anything that it takes. Really. (SAD)"
    ...
    goro "I'll try to talk to her. (SOUND: SIGH)"
    ...
    goro "I'll coach you before your first presentation. I know this is something that you can do. (SMILE)"
    goro "Just do your absolute best in the meantime, okay? (SMILE)"
    player "… okay. (SAD)"
    ...
    maria "Not cut out for what? (ENTER: RIGHT)"
    player "Oh."
    player "Hey Maria."
    ...
    maria "…"
    maria "Want to see something cool? (SMILE)"
    ...
    player "What…?"
    player "Is that…"
    maria "A calculator! I made it myself! (SMILE)"
    ...
    player "Wow… this is amazing Maria. (SMILE)"
    ...
    maria "Just make sure that you don't let it get in the way of your assignments. I've made that mistake before too. (LAUGH)"
    player "Thanks Maria. For all of this."
    player "This was the pep-talk I needed."
    maria "You've got this! (SMILE)"
    ...
    # BEGIN POPUP "
    # NEW TASKS:"
    # * Complete 3 client presentations"
    # * Complete 30 tickets"
    # "
    return
...
label v2_redemption:
    ...
    oliver "Thanks, Darius. (SOUND: SIGH)"
    "When you arrive back at the office from your lunch break, the entire team seems frantic."
    ...
    oliver "He was in a rush to get on his flight for a vacation, and the client's site is due today. (SOUND: OFFICE PHONE)"
    player "Can't we just get IT to get into his computer and push it from there? (SOUND: OFFICE PHONE)"
    oliver "Ugh - just a moment, I need to go prepare my notes on how I'm going to tell them that we may not meet the deadline. (EXIT: RIGHT)"
    mala "Not possible, small fry. Darius says he saw him leave WITH his laptop the day he started his vacation. (ENTER: LEFT)"
    mala "We checked his desk and couldn't find it anywhere."
    darius "I'm almost certain I saw him working on it earlier that day, too. He was just about done. (ENTER: RIGHT)"
    ...
    # * Darius | Mala: (EXIT: RIGHT)"
    player "W-wait! How can I help? What else needs to be done? (SWEAT)"
    goro "There's lots to do. It's going to be all hands on deck cleaning this situation up. (ENTER: LEFT)"
    ...
    iris "If we lose this client, a lot of money will go with them. (ENTER: RIGHT)"
    player "Ah! H-hey, Iris. (SWEAT)"
    iris "… We cannot afford to have them terminate our services. (SWEAT)"
    player "(Is Iris actually… NERVOUS?)"
    player "(This must be serious.)"
    player "How can I help? (HAPPY)"
    ...
    iris "We could do something like that with Regex… (DISGUST)"
    goro "But Kyle was the only one here that knew how to use it. (SOUND: SIGH)"
    player "Regex? I've been studying Regex?"
    iris "Really? Can you fix this?"
    player "Give me a moment - I definitely can!"
    player "… (SOUND: TYPING)"
    player "There!"
    goro "Huh - that works! (SMILE)"
    ...
    player "Seriously?"
    player "Regex can handle all of that too! (LAUGH) "
    ...
    darius "Ugh - I'm so TIRED. (SOUND: YAWN)"
    mala "Yeah… that was exciting and everything, but…"
    mala "I never want to be excited under these circumstances again. (SWEAT HAPPY)"
    goro "You and me both. Great job team! (LAUGH)"
    goro "I think some special thanks are in order for [player_name] as well. (SMILE)"
    darius "Seriously! I obviously need to learn some Regex myself! (LAUGH)"
    ...
    player "Y-yes?"
    iris "…"
    iris "Good job today. (SMILE)"
    iris "You surpassed my expectations."
    player "…"
    player "(Iris… SMILED at me!) (SMILE)"
    player "I'm glad that I could help! (SMILE) "
    ...
    iris "I'd like to have a word with you. (SMILE)"
...
label v2_fresssh:
    ...
    player "Users Surfer90210 and BroDoYouBamBam are talking about some technologies I've never heard of?"
    player "Hm... I see..."
    player "According to BroDoYouBamBam, all developers should know how to use BamBam at least a little..."
    ...
    menu:
        "Learn about BamBam technology and Fresssh.":
            player "Okay,"
            player "So it seems that a lot of people can't seem to agree if BamBam is going to be a big deal or not..."
            ...
            player "So I was on this forum that I really like, and I read about some users talking about BamBam, as well as this new framework..."
            "You send over pictures of the small webpage that you made using Fresssh."
            "You also explain how you think that it and BamBam could be really useful to the team."
            ...
            player "I see..."
            goro "Similarly, BamBam hasn't been adopted by many major companies either."
            goro "We could certainly use it, but there are far, far fewer BamBam developers than, say, Ruby on Rails developers."
